...
<?php 
	...
	{
		$confirmation_message .= "<hr><p>" . sprintf(__('Ci-dessous, les informations concernant votre compte sur la plateforme KinoGeneva ! Un email de bienvenue vous a été envoyé à %s.', 'pmpro'), $current_user->user_email) . "</p>";
